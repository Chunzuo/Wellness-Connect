            ...
            <div class="widget widget_text">
              ...
              <div class="textwidget">
                ...
                <ul class="list-unstyled store-btns">
                  <li>
                    <a href class="btn-gradient btn-gradient-two btn btn-md btn-icon icon-left">
                      <span class="fab fa-apple"></span> App Store
                    </a>
                  </li>
                  <li>
                    <a href class="btn btn-dark btn-md btn-icon btn-icon">
                      <span class="fab fa-android"></span> Google Play
                    </a>
                  </li>
                </ul>
              </div>
          ...
          <div class="col-lg-12">
            <div class="footer-bottom--content">
              ...
              <p class="m-0 copy-text">
                ©2020 Provider Connect. Made with
